...
//				mObj.setyLocation(mObj.moveY(elapsedMillisecs, height));
				...
				mObj.moveX(elapsedMillisecs, width);
				mObj.moveY(elapsedMillisecs, height);
				
				//mObj.translate((float)width, (float)height);
				//calling the move methods for both x and y locations 
				//mObj.translate((float)mObj.getxLocation(), (float)mObj.getyLocation());
			}
		}
